...
public: //member functions
	...
	double kernel(int r, double k, double theta, double c, double sig, double del, std:: string& base);
	double findError(double h1,double h2);
	double ar(int r, double k, double theta, double c, double sig, double del, std:: string& base);
	double beta(int n, int r, double k, double theta, double c, double sig, double del, std:: string& base);
